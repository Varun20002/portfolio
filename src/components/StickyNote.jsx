...
export default function StickyNote({
  ...
  return (
    <div className={`${color} p-6 border-l-4 border-black shadow-lg transform ${rotation} hover:rotate-0 transition-all duration-300 w-full md:w-64 relative group`}>
      ...
      <h3 className={`font-hand text-3xl font-bold mb-2 ${isCurrent ? 'text-[#D32F2F]' : ''}`}>{title}</h3>
      {body}
